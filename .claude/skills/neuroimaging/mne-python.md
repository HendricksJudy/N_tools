...
MNE-Python is a neuroimaging tool used for brain imaging analysis and processing.
...
- Check the official documentation at https://mne.tools/ for detailed usage
