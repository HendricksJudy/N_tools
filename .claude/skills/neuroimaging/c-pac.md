...
C-PAC is a neuroimaging tool used for brain imaging analysis and processing.
...
```bash
# Example command
c-pac [options] input_file output_file
```
...
- Check the official documentation at https://fcp-indi.github.io/ for detailed usage
...
- Official documentation: https://fcp-indi.github.io/
- Platform: Docker/Singularity
