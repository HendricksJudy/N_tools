...
CURRY (commercial) is a neuroimaging tool used for brain imaging analysis and processing.

- **Website:** https://compumedicsneuroscan.com/
- **Platform:** Windows
- **Languages:** N/A
...
```bash
# Example command
curry [options] input_file output_file
```
...
- Check the official documentation at https://compumedicsneuroscan.com/ for detailed usage
...
When working with CURRY (commercial):
...
- Official documentation: https://compumedicsneuroscan.com/
- Platform: Windows
