...
FreeSurfer is a neuroimaging tool used for brain imaging analysis and processing.
...
```bash
# Example command
freesurfer [options] input_file output_file
```
...
- Check the official documentation at https://surfer.nmr.mgh.harvard.edu/ for detailed usage
...
- Official documentation: https://surfer.nmr.mgh.harvard.edu/
- Platform: Linux/macOS
