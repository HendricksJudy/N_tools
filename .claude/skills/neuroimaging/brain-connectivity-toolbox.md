...
Brain Connectivity Toolbox (BCT) is a neuroimaging tool used for brain imaging analysis and processing.
...
```python
import brain_connectivity_toolbox
...
- Check the official documentation at https://sites.google.com/site/bctnet/ for detailed usage
...
When working with Brain Connectivity Toolbox (BCT):
