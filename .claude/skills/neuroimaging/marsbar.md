...
MarsBaR is a neuroimaging tool used for brain imaging analysis and processing.

- **Website:** http://marsbar.sourceforge.net/
- **Platform:** MATLAB/SPM
- **Languages:** MATLAB
...
- Check the official documentation at http://marsbar.sourceforge.net/ for detailed usage
...
- Official documentation: http://marsbar.sourceforge.net/
- Platform: MATLAB/SPM
