...
PhysIO (TAPAS) is a neuroimaging tool used for brain imaging analysis and processing.

- **Website:** https://tapas.gitlab.io/physio/
- **Platform:** MATLAB/SPM
- **Languages:** MATLAB
...
- Check the official documentation at https://tapas.gitlab.io/physio/ for detailed usage
...
When working with PhysIO (TAPAS):
...
- Official documentation: https://tapas.gitlab.io/physio/
- Platform: MATLAB/SPM
