...
SnPM (Statistical NonParametric Mapping) is a neuroimaging tool used for brain imaging analysis and processing.
...
- Check the official documentation at http://warwick.ac.uk/snpm for detailed usage
...
When working with SnPM (Statistical NonParametric Mapping):
...
- Official documentation: http://warwick.ac.uk/snpm
- Platform: MATLAB/SPM
