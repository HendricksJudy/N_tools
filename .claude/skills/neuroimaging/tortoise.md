...
TORTOISE is a neuroimaging tool used for brain imaging analysis and processing.
...
```bash
# Example command
tortoise [options] input_file output_file
```
...
- Check the official documentation at https://tortoise.nibib.nih.gov/ for detailed usage
...
- Official documentation: https://tortoise.nibib.nih.gov/
- Platform: Windows/Linux
