...
VBM8 (legacy) is a neuroimaging tool used for brain imaging analysis and processing.
...
- Check the official documentation at http://dbm.neuro.uni-jena.de/vbm/ for detailed usage
...
- Official documentation: http://dbm.neuro.uni-jena.de/vbm/
- Platform: MATLAB/SPM
