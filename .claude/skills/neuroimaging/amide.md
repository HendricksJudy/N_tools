...
AMIDE is a neuroimaging tool used for brain imaging analysis and processing.
...
```bash
# Example command
amide [options] input_file output_file
```
...
- Check the official documentation at http://amide.sourceforge.net/ for detailed usage
