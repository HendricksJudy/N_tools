...
- User guide: https://github.com/aces/CIVET/wiki
- Downloads: https://www.bic.mni.mcgill.ca/ServicesSoftware/CIVET
- Support: https://forum.cbrain.mcgill.ca/

## Citation

```bibtex
@inproceedings{addabbagh2006civet,
  title={CIVET: Automated pipeline for cortical surface-based analysis},
  author={Ad-Dab'bagh, Yasser and Lyttelton, Oliver and Muehlboeck, J.-S. and others},
