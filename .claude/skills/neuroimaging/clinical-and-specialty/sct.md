...
- Docs: https://spinalcordtoolbox.com/user_section/overview.html
- Tutorials: https://spinalcordtoolbox.com/overview/tutorials.html
- Source: https://github.com/spinalcordtoolbox/spinalcordtoolbox

## Related Tools

- **ANTs/ANTsX:** Registration components often used with SCT outputs
- **FSL (FLIRT/SUSAN):** Complementary preprocessing steps
- **BIDS Validator:** Validate spinal cord BIDS derivatives
