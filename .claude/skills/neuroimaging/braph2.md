...
BRAPH2 is a neuroimaging tool used for brain imaging analysis and processing.

- **Website:** http://braph.org/
- **Platform:** MATLAB
- **Languages:** MATLAB
...
- Check the official documentation at http://braph.org/ for detailed usage
...
- Official documentation: http://braph.org/
- Platform: MATLAB
