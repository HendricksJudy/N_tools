...
```bibtex
@misc{rapidtide2022,
  title={rapidtide: physiological denoising and lag mapping for fMRI},
  author={Frederick, Blaise and contributors},
  year={2022},
  howpublished={\url{https://github.com/bbfrederick/rapidtide}}
}
```
