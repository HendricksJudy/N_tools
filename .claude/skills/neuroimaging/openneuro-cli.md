...
OpenNeuro CLI is a neuroimaging tool used for brain imaging analysis and processing.
...
- Check the official documentation at https://openneuro.org/ for detailed usage
...
When working with OpenNeuro CLI:
...
- Official documentation: https://openneuro.org/
- Platform: Node.js/Python
