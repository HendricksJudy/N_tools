...
TARQUIN is a neuroimaging tool used for brain imaging analysis and processing.
...
```bash
# Example command
tarquin [options] input_file output_file
```
...
- Check the official documentation at https://tarquin.sourceforge.net/ for detailed usage
...
- Official documentation: https://tarquin.sourceforge.net/
- Platform: C++
