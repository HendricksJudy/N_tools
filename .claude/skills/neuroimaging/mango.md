...
Mango is a neuroimaging tool used for brain imaging analysis and processing.
...
```bash
# Example command
mango [options] input_file output_file
```
...
- Check the official documentation at http://ric.uthscsa.edu/mango/ for detailed usage
...
- Official documentation: http://ric.uthscsa.edu/mango/
- Platform: Java
