...
**Category:** Neuroimaging - General

## Overview

FSLeyes is a neuroimaging tool used for brain imaging analysis and processing.

- **Website:** https://open.win.ox.ac.uk/pages/fsl/fsleyes/fsleyes.html
...
```bash
# Example command
fsleyes [options] input_file output_file
```
...
- Check the official documentation at https://open.win.ox.ac.uk/pages/fsl/fsleyes/fsleyes.html for detailed usage
...
- Official documentation: https://open.win.ox.ac.uk/pages/fsl/fsleyes/fsleyes.html
- Platform: Win/macOS/Linux
