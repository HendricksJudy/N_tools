...
**Category:** Neuroimaging - Electrophysiology

## Overview

LIMO EEG is a neuroimaging tool used for brain imaging analysis and processing.

- **Website:** https://github.com/LIMO-EEG-Toolbox/limo_eeg
...
- Check the official documentation at https://github.com/LIMO-EEG-Toolbox/limo_eeg for detailed usage
...
- Ensure MATLAB license is valid and accessible
- Check toolbox dependencies

## Integration with Claude Code

When working with LIMO EEG:
...
- Official documentation: https://github.com/LIMO-EEG-Toolbox/limo_eeg
- Platform: MATLAB/EEGLAB
