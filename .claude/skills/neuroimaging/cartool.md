...
CARTOOL is a neuroimaging tool used for brain imaging analysis and processing.
...
```bash
# Example command
cartool [options] input_file output_file
```
...
- Check the official documentation at https://sites.google.com/site/cartoolcommunity/ for detailed usage
...
- Official documentation: https://sites.google.com/site/cartoolcommunity/
- Platform: Windows
