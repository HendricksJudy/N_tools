...
xcpEngine is a neuroimaging tool used for brain imaging analysis and processing.
...
```bash
# Example command
xcpengine [options] input_file output_file
```
...
- Check the official documentation at https://xcpengine.readthedocs.io/ for detailed usage
...
- Official documentation: https://xcpengine.readthedocs.io/
- Platform: Linux
