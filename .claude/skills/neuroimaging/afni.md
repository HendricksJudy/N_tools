...
AFNI is a neuroimaging tool used for brain imaging analysis and processing.
...
```bash
# Example command
afni [options] input_file output_file
```
...
- Check the official documentation at https://afni.nimh.nih.gov/ for detailed usage
...
- Official documentation: https://afni.nimh.nih.gov/
- Platform: Linux/macOS
