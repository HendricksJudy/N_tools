...
**Category:** Neuroimaging - Connectivity

## Overview

NBS (Network-Based Statistic) is a neuroimaging tool used for brain imaging analysis and processing.
...
- Check the official documentation at https://www.nitrc.org/projects/nbs/ for detailed usage
...
When working with NBS (Network-Based Statistic):
...
- Official documentation: https://www.nitrc.org/projects/nbs/
- Platform: MATLAB
