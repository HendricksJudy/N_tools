...
ANTsR is a neuroimaging tool used for brain imaging analysis and processing.
...
```bash
# Example command
antsr [options] input_file output_file
```
...
- Check the official documentation at https://github.com/ANTsX/ANTsR for detailed usage
...
- Official documentation: https://github.com/ANTsX/ANTsR
- Platform: R
