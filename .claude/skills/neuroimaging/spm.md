...
SPM is a neuroimaging tool used for brain imaging analysis and processing.

- **Website:** https://www.fil.ion.ucl.ac.uk/spm/
- **Platform:** MATLAB (Win/macOS/Linux)
- **Languages:** MATLAB
...
- Check the official documentation at https://www.fil.ion.ucl.ac.uk/spm/ for detailed usage
...
- Official documentation: https://www.fil.ion.ucl.ac.uk/spm/
- Platform: MATLAB (Win/macOS/Linux)
