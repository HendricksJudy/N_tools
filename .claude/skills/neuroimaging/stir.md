...
STIR is a neuroimaging tool used for brain imaging analysis and processing.
...
```bash
# Example command
stir [options] input_file output_file
```
...
- Check the official documentation at http://stir.sourceforge.net/ for detailed usage
